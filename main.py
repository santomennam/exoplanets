...
Arrakis = planetSystem('Arrakis', 0, 2.3, 0, 0, 1, 0.979, 0.843)
Arrakis.setSurfaceTemp(325) # from the wiki or literature # star is canopus
Erid = planetSystem('Erid', 0, 0.4, 0, 0, 1, 2, 8)
Erid.setSurfaceTemp(420)
Mesklin = planetSystem('Mesklin', 0, 3.3, 0, 0, 1, 7.85, 5086.51)  # Radius is an average
Mesklin.setSurfaceTemp(100)
Habranah = planetSystem('Habranah', 0, 1.5, 0, 0, 1, 0.21, 0.01)
Habranah.setSurfaceTemp(195)  # Surface Temperature is an average due to tidal locking
Dhrawn = planetSystem('Dhrawn', 0, 0.3, 0, 0, 1, 8.5, 3000)
Dhrawn.setSurfaceTemp(250)
Hekla = planetSystem('Hekla', 0, 0.3, 0, 0, 1, 2, 1.45)
Hekla.setSurfaceTemp(260)
Sarr = planetSystem('Sarr', 0, 1.6, 0, 0, 1, 0.76, 0.45)
Sarr.setSurfaceTemp(800)
Tenebra = planetSystem('Tenebra', 0, 2, 0, 0, 1, 3, 27)
Tenebra.setSurfaceTemp(650)
